...
class SisabCondicaoAvaliadaParserTest(unittest.TestCase):
    def test_parse_sisab_csv_returns_tidy_condicao_rows(self) -> None:
        rows = parse_sisab_csv(SISAB_CONDICAO_CSV, "202604", "De 30 a 34 anos", "Masculino")
    ...
    def test_sort_tidy_rows_is_stable_for_output(self) -> None:
        rows = [
            {"competencia": "202604", "uf": "AC", "ibge": "2", "municipio": "B", "faixa_etaria": "De 5 a 9 anos", "sexo": "Masculino", "condicao_avaliada": "Z", "valor": 1},
            {"competencia": "202603", "uf": "AC", "ibge": "1", "municipio": "A", "faixa_etaria": "De 1 a 4 anos", "sexo": "Feminino", "condicao_avaliada": "A", "valor": 1},
        ]
    ...
    def test_default_output_path_is_per_competencia(self) -> None:
        ...
        self.assertEqual(str(path), "out/sisab_saude_condicao_avaliada_202604.csv")
